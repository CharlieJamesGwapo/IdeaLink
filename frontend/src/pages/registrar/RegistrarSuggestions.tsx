    ...
    <div className="animate-fade-in space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">Registrar Office — {suggestions.length} submissions</p>
        </div>
        <div className="flex items-center gap-3">
          <button
            onClick={() => exportToCSV(filtered, 'registrar-suggestions')}
      ...
      {isLoading ? (
        ...
        <div className="text-center py-20 glass rounded-2xl">
          ...
          <p className="text-gray-600 text-sm mt-1">Suggestions for Registrar will appear here</p>
        </div>
      ) : (
