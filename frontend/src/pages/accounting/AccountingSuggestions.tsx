      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <h1 className="text-2xl font-bold text-white font-display">Finance Office Feedback</h1>
          </div>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-20 glass rounded-2xl">
          ...
          <p className="text-gray-600 text-sm mt-1 font-ui">
            {search ? 'Try a different search.' : filter !== 'all' ? `No ${filter.toLowerCase()} submissions.` : 'Finance Office feedback will appear here.'}
          </p>
        </div>
      ) : (
